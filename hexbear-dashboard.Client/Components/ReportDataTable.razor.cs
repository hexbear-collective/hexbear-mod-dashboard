...
namespace hexbear_dashboard.Client.Components;
public partial class ReportDataTable
{
    [Parameter]
    public List<ReportItem> ReportItems { get; set; }
    public List<ReportItem> FilteredReportItems { get; set; }
    [Parameter]
    ...
    {
        this.FilteredReportItems = ReportItems;
    ...
    {
        _searchString = s;
        this.FilteredReportItems = this.ReportItems.Where(_quickFilter).ToList();
    }
}
