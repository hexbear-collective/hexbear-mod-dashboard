...
using hexbear_dashboard.Components;
...
namespace hexbear_dashboard
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<HexbearAPIClient>();
    ...
    public class AuthMiddleware
    {
        ...
        {
# if DEBUG
            user.LocalUser = await db.LocalUsers.Include(x => x.Person).FirstAsync(x => x.Person.Name == "makotech222");
            await _next(context);
            return;
#endif
